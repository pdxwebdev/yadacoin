...
class Contract:
    ...
    # DISABLED: never called from app.py or any reachable code path (attack surface reduction)
    # @staticmethod
    ...
    #             "transactions": {
    #                 "$elemMatch": {
    #                     "id": {"$ne": transaction_obj.transaction_signature}
    #                 }
    #             },
    #             "transactions": {
    #                 "$elemMatch": {
    ...
    #         return
    #     for smart_contract in smart_contract_block.get(
    #         "transactions"
    #     ):
    #         if (
    #             smart_contract.get("relationship")
    #             and isinstance(
    #                 smart_contract.get("relationship"), dict
    #             )
    #             and Collections.SMART_CONTRACT.value
    #             in smart_contract["relationship"]
    #         ):
    #             smart_contract_obj = Transaction.from_dict(
    #                 smart_contract
    #             )
