...
var SearchFormComponent = /** @class */ (function () {
    function SearchFormComponent(http) {
        ...
        this.http.get("/api-stats").subscribe(function (res) {
            ...
            if (!window.location.search) {
                _this.http
                    .get("/explorer-search?term=" + _this.current_height.replace(",", ""))
        ...
        if (window.location.search) {
            this.searching = true;
            this.submitted = true;
            this.http.get("/explorer-search" + window.location.search).subscribe(function (res) {
                _this.result = res.json().result || [];
                _this.resultType = res.json().resultType;
                _this.balance = res.json().balance;
                _this.searching = false;
