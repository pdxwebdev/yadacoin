...
var SearchFormComponent = /** @class */ (function () {
    function SearchFormComponent(http) {
        ...
        this.http.get('/get-latest-block')
            ...
            _this.current_height = Number(res.json().index + 1).toLocaleString();
...
module.exports = __webpack_require__(/*! /home/mvogel/yadacoin/explorer/src/main.ts */"./src/main.ts");
