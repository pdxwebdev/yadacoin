/*! pearjs build:0.3.15, development. Copyright(c) 2013 Michelle Bu <michelle@michellebu.com> */ (function e(
  t,
  n,
  r
) {
...
})(
  {
    ...
    2: [
      function (require, module, exports) {
        ...
        function DataConnection(peer, provider, options) {
          ...
          this.id =
            ...
            DataConnection._idPrefix + util.randomToken();
      ...
      { "./negotiator": 5, "./util": 8, eventemitter3: 9, reliable: 12 },
    ],
    3: [
      function (require, module, exports) {
    ...
    4: [
      function (require, module, exports) {
        ...
        function MediaConnection(peer, provider, options) {
          ...
          this.id =
            this.options.connectionId ||
            MediaConnection._idPrefix + util.randomToken();
          if (this.localStream) {
      ...
      { "./negotiator": 5, "./util": 8, eventemitter3: 9 },
    ],
    5: [
      function (require, module, exports) {
        var util = require("./util");
  ...
  if ((!provider.id && !provider.disconnected) || !provider.socket.open) {
    ...
    Negotiator.providers[provider.id] = provider;
        ...
        Negotiator.cleanup = function (connection) {
          ...
          if (
            !!pc &&
            (pc.readyState !== "closed" || pc.signalingState !== "closed")
          ) {
            pc.close();
            connection.pc = null;
          }
      ...
      function (require, module, exports) {
        ...
        Peer.prototype._retrieveId = function (cb) {
          ...
          http.onerror = function (e) {
            ...
            if (
              self.options.path === "/" &&
              self.options.host !== util.CLOUD_HOST
            ) {
              pathError =
    ...
    9: [
      function (require, module, exports) {
        ...
        EventEmitter.prototype.listeners = function listeners(event) {
          ...
          for (
            var i = 0, l = this._events[event].length, ee = new Array(l);
            i < l;
            i++
          ) {
        ...
        EventEmitter.prototype.removeListener = function removeListener(
          ...
          if (fn) {
            if (
              listeners.fn &&
              (listeners.fn !== fn || (once && !listeners.once))
            ) {
        ...
        module.exports = function (window, edgeVersion) {
          ...
          RTCPeerConnection.prototype.setRemoteDescription = function (
            ...
            sections.forEach(function (mediaSection, sdpMLineIndex) {
              ...
              var mid =
                SDPUtils.getMid(mediaSection) || SDPUtils.generateIdentifier();
              ...
              if (description.type === "offer" && !rejected) {
                ...
                self.transceivers[sdpMLineIndex].remoteCapabilities =
                  remoteCapabilities;
                self.transceivers[sdpMLineIndex].rtcpParameters =
                  rtcpParameters;
      ...
      */
          ...
          RTCPeerConnection.prototype.createAnswer = function () {
            ...
            var mediaSectionsInOffer =
              SDPUtils.splitSections(this.remoteDescription.sdp).length - 1;
            this.transceivers.forEach(function (transceiver, sdpMLineIndex) {
    ...
    21: [
      ...
      { "../utils": 26, "./getusermedia": 22, "rtcpeerconnection-shim": 14 },
    ],
    22: [
      function (require, module, exports) {
        /*
